  ...
  return (
    <nav className={`navbar navbar-${props.mode} navbar-expand-lg bg-${props.mode}`}>
      <div className="container-fluid">
        <Link className="navbar-brand fs-2" to="/">{props.title}</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0 mx-5">
            ...
            <li className="nav-item">
              <Link className="nav-link fs-5" to="/about">{props.aboutText}</Link>
            </li>

            <li className="nav-item">
              <Link className="nav-link fs-5" to="/">Contact Us</Link>
            </li>
          </ul>
          ...
          {/* <div className="d-flex">
            ...
            <div className="bg-warning rounded mx-2" onClick={()=>{props.toggleMode('dark')}} style={{height:'20px', width:'20px'}}></div>
          </div> */}
