...
export default function Navbar(props) {
  ...
  return (
    <>
      <nav className={`navbar navbar-${props.mode} navbar-expand-lg`} style={{ backgroundColor: props.mode === 'dark' ? materialColors.darkForm : materialColors.lightForm }}>
        ...
        <div className="switchContainer">
          <label className="switch darkModeSwitch">
